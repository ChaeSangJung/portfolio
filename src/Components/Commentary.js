...
const Commentary = ({type}) => {
    ...
    return (
        <Container>
          ...
          : type === "tvcPoc" ? (
            <TextComment>
                한국기계산업진흥회와 협력하여 산업부의 의뢰를 받아 진행한 POC(Proof of Concept)입니다.<br/> 
                이 프로젝트는 특허와 연계하여 특허의 산업 분야와 무역 상황을 파악할 수 있는 기능을 제공하며, 나아가 인공지능(AI)을 활용하여 '기술개발 로드맵'과 'RFP(Request For Proposal: 프로젝트를 수행할 업체를 선정하기 전에 요구 사항을 정리하여 후보 업체에게 전달하는 문서)'을 제공합니다.<br/>
                이 프로젝트는 저에게 처음으로 리딩을 맡은 경험입니다.<br/>
                또한, 팀원들에게는 처음 사용해보는 라이브러리(am-chart, keylines 등)에 대한 사전 연구를 수행하고, 팀원들에게 가이드를 제공하여 지원했습니다.<br/>
                ...
                <br/><br/>
                디지털 시각화 분야에 대한 큰 흥미를 자아내게 했습니다.<br/>
                특히, 특허와 무역 상황을 연계하여 시각적으로 표현하는 것은 현실적이고 실질적인 문제 해결에 매우 유용한 접근이었습니다.<br/>
                이 프로젝트를 통해 기술과 비즈니스의 융합이 얼마나 강력한 결과를 낼 수 있는지를 몸소 체험하게 되었습니다.<br/>
                이러한 흥미와 욕심을 바탕으로 더 다양한 프로젝트에 참여하고 싶은 욕구가 강해졌습니다.<br/>
                다양한 분야에서 디지털 시각화와 기술의 융합을 활용하여 복잡한 문제들을 해결하는 프로젝트에 참여하고 싶다는 생각이 들게 했습니다.<br/>
                예를 들어, 산업의 다양한 영역에서 데이터 분석과 시각화를 통해 생산성을 향상시키거나, 사회문제와 관련된 데이터를 시각화하여 보다 지속 가능한 방향으로 전환하는 프로젝트 등이 가능할 것입니다.<br/>
                이를 위해 저는 먼저 관련된 기술과 도구들을 깊이 학습하고, 선행 연구 및 프로젝트를 조사하여 다양한 해결책을 모색할 계획입니다.<br/>
                또한, 학습한 내용을 팀원들과 공유하며 협업하는 과정을 통해 더 큰 성과를 이루고 싶습니다.<br/>
                이런 방식으로 저의 욕심을 실현하기 위해 지속적으로 노력하고 발전해 나가려고 합니다.
            </TextComment>
          )
          :type === "network" ? (
            <TextComment>                
                앞으로 진행할 POC(proof of concept)에 대비하여 관계망 템플릿을 미리 작업하고 있습니다.<br/>
                key-lines(https://keylines.io)에서 제공하는 기능들을 활용하여 다양한 작업을 진행하고 있습니다.<br/>
                이 작업은 노드 크기 조절(기업 규모, 산업 분류 등), 뷰(렌즈 형태, 표준 형태, 구조 형태, 맵과의 연동), 노드의 확장 및 축소, 필터(기업 규모 등), 통계, 병합, 검색, 워드 클라우드, 타임라인, 선택 기능 등을 포함합니다.<br/>
                이러한 기능들을 컴포넌트화하여, 필요한 부분만 선택적으로 사용할 수 있도록 구현하고 있습니다.
                <br/><br/>
                마치 레고 블록을 조립하는 것처럼 필요한 기능들을 모듈화하고, 이를 조합하여 프로젝트의 요구사항에 맞게 활용할 수 있는 구조를 만드는 것이 목표입니다.<br/>
                이렇게 함으로써 프로젝트를 효율적으로 관리하고 확장성을 높일 수 있을 것으로 기대하고 있습니다.<br/>
                이러한 계획을 실현하기 위해서는 먼저 key-lines과 같은 도구와 기술에 대한 깊은 이해와 숙련이 필요합니다.<br/>
                또한, 컴포넌트화와 모듈화된 접근 방식을 통해 필요한 기능들을 세심하게 분리하고 통합할 수 있어야 합니다.<br/>
                이 과정에서 효율적인 협업과 지속적인 테스트와 개선이 중요한 역할을 할 것입니다.<br/>
